...
document.onkeydown = function(e){
 ...
 setInterval(() =>{
    ...
    if(offsetX<73 && offsetY<52){
        ...
        setTimeout(() =>{
            aniDur = parseFloat(window.getComputedStyle(obstacle, null).getPropertyPriority('animation-duration'));
            newOur =aniDur -0.1;
            ontransitioncancel.style.animationDuration =newOur +"s";
            console.log('New animation duration:',newOur)
        },500);
    }
